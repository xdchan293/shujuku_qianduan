  ...
  <div class="student_main"> 
    <el-card>
     ...
     <el-table :data="datalist" border stripe>
            ...
            <!-- <el-table-column  label="年级" prop="gender" ></el-table-column> -->
    ...
    <el-dialog
      ...
      <el-form-item label="学工号" class="input_item">
       <el-input 
        style="width:220px"
      ...
      <el-form-item label="年级" class="input_item">
       <el-input 
        style="width:220px"
      ...
      <el-form-item label="专业" class="input_item">
       <el-input 
        style="width:220px"
      ...
      <!-- <el-form-item label="辅导员id" class="input_item">
       <el-input 
        style="width:220px"
...
methods: {
  async getDataList() {
   ...
   console.log(reqData)
    const {data:res} = await this.$http.get('student/getStudentAllInfoPage',{
  ...
  const {data:res1} = await this.$http.get('major/getMajorPage',{
    params:{
      majorName:this.addForm.majorName
    }
  })
  
   const {data:res2} = await this.$http.post('student/createStudent',{
    studentName:this.addForm.studentName,
    studentId:this.addForm.studentId,
    gender:this.addForm.gender,
    deptId:res1.data.records[0].deptId,
    schoolId:res1.data.records[0].schoolId,
 ...
 async delItemByid(item) {
    ...
    console.log(req)
    const {data:res} = await this.$http.get('student/deleteStudent',{
      params: req
    })
    console.log(res)
    if(res.code!==200)
